...
4. **Public operations:** registry preview version `1bf1e03e-6899-4c0e-b9b9-e992a3ccc891` has immediate rollback target `96c19f70-fa34-443e-b8ac-d9a904bcb025`. Existing Free defaults remain; custom CPU limits were rejected without paid activation. Apex/www remain on Pages and production registry/login/browsers retain old Workers. Resolve ownership, cost/escalation, old clients and Railway mapping before cutover.
