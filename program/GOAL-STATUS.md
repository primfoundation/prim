...
| G2 Public Hub | in progress | Hub PR #5 merged; four canonical profiles generate human pages/API/MCP; real local Worker and external MCP client parity pass in CI `34086822519` | Clawdflare connected and isolated preview created but disabled; resolve asset-upload HTTP 401 token verification failure, then public preview acceptance; ownership/budget, old website/route migration, accessibility, monitoring and recovery drill |
