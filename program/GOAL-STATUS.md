...
| G2 Public Hub | in progress | Four-profile preview deployed with exact tested module and five Static Assets; homepage observed live; hosted CI `34146877288` passes public HTTP/assets and both MCP modes for all four kits; deployed version and client evidence preserved | independent acceptance; ownership/budget, old website/route migration, accessibility, edge controls, monitoring and recovery drill |
