...
| Primboard Mac release | Private source recovery verified on both Macs; clean current-source company-signed candidate built; usable notary profile and saved submission in progress | Resume the existing notarization submission; prove Apple acceptance, staple/Gatekeeper and installed existing-store, Touch ID/TCC and app/CLI results. Keep keys/private records out of public issues. |
